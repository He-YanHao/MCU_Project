...
#define GRAY0   0xEF7D   	//灰色0 31650 011000 10110 0101
...
//飞线的各种线的宏定义
//#define LCD_SCL_SET GPIO_SetBits(GPIOA,GPIO_Pin_5)//PA5时钟线置为高电平。
//#define LCD_SCL_CLR GPIO_ResetBits(GPIOA,GPIO_Pin_5)//PA5时钟线置为低电平。
