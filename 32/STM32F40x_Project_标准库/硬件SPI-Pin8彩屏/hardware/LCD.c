...
void LCD_GPIO_Init(void)//连续的
{
    ...
    //引脚复用
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource13, GPIO_AF_SPI2);//MISO  
    ...
    /* 配置SPI引脚引脚SCK */    /* 配置SPI引脚MISO */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_15;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//最快速
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;//复用
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;//无上拉or下拉  
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_64; // SPI时钟预调因数为2
