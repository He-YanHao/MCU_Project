...
//    MyFOC_NUM.U_a = 1.14 * fabs (MyFOC_NUM.U_alpha);
//    MyFOC_NUM.U_b = 1.14 * fabs ((sqrt(3)*MyFOC_NUM.U_beta - MyFOC_NUM.U_alpha)/2);
//    MyFOC_NUM.U_c = 1.14 * fabs ((- MyFOC_NUM.U_alpha - (sqrt(3))*MyFOC_NUM.U_beta)/2);
}    
