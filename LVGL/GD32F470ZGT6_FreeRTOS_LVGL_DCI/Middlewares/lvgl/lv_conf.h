...
#define LV_MEM_CUSTOM 0
    ...
    // 指定允许lv_mem_alloc申请的堆栈大小和 不小于2kb
    #define LV_MEM_SIZE (2U * 1024U * 1024U)

    /*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    // 指定 LVGL 内存池的起始地址
    // 如果指定地址（推荐），可以将内存池放到外部 SDRAM
    extern uint8_t Image$$RW_LVGL_HEAP$$Base;
    #define LV_MEM_ADR Image$$RW_LVGL_HEAP$$Base
...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".sdram.draw")))
