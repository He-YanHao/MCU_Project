...
#define	LCD_RST_SET  GPIOC->BSRR=1<<11    //复位  	    	 PC15
...
#define	LCD_RD_SET	GPIOC->BSRR=1<<10    //读数据					 PC14

#define	LCD_RST_CLR  GPIOC->BRR=1<<11    //复位  	    		 PC15
...
#define	LCD_RD_CLR	GPIOC->BRR=1<<10     //读数据					 PC14  	
