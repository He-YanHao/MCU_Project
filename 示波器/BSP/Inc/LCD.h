...
//颜色的宏定义
#define RED  	0xf800  //红色  黑色
#define GREEN	0x07e0  //绿色  很暗的绿色
#define BLUE 	0x001f  //蓝色  深蓝色
#define WHITE	0xffff  //白色  浅蓝色
#define BLACK	0x0000  //黑色  黑色
#define YELLOW  0xFFE0  //黄色  很暗的绿色
...
//各种线的宏定义
#define LCD_RST_SET GPIO_SetBits(GPIOA,GPIO_Pin_3)
#define LCD_RST_CLR GPIO_ResetBits(GPIOA,GPIO_Pin_3)
